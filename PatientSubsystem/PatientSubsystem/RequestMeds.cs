...
{
    public partial class RequestMeds : Form
    {
        int prescriptionID;
        int ID;
        string patientFName;
        ...
        public RequestMeds(int patientID)
        {
            this.ID = patientID;
            InitializeComponent();
        }
        ...
        private void RequestMeds_Load(object sender, EventArgs e)
        {
        ...
        private void prescriptionIDTextBox_TextChanged(object sender, EventArgs e)
        {
            if (!prescriptionIDTextBox.Text.Equals(""))
            {
                try
                {
                    prescriptionName = prescriptionIDTextBox.Text;
                }
                catch (Exception ex)
                {
